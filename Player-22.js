/* Player creato da Gianluca Rovitti
*/
(function(a, k) {
...
if ("" != dc && -1 != a.indexOf(b) && 4 < b.length || a.indexOf("www.flashradio.info") || a.indexOf(".sodah.de")) W(), ec(), song_timer = setInterval(function() {
ec()
}, fc), Sa = !0;
...
crossDomain: !0,
cache: !1,
url: "https://zenoplay.zenomedia.com/api/zenofm/nowplaying/qdqk79beu0hvv?_=1661556910587" + Math.random(),
dataType: "json",
async: !0,
success: function(a) {
if (a) try {
